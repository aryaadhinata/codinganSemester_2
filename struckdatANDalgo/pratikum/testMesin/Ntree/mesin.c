    ...
    if(root != NULL){
        ...
        if(hapus != NULL){
            if(hapus->sibling == NULL){
                ...
                if(strcmp(root->child->kontainer.str, temp.str) == 0){
                    delAll(root->child);
                    root->child = NULL;
                }else{
                ...
                while((hapus->sibling != root->child) && (ketemu == 0)){
                    // jika ada banyak struck maka bandingkan semuanya
                    if(strcmp(hapus->kontainer.str, temp.str) == 0){
                        ketemu = 1;
                    }else{
                        prev = hapus;
                        hapus = hapus->sibling;
                ...
                // jika ada banyak struck maka bandingkan semuanya
                if((ketemu == 0) && (strcmp(hapus->kontainer.str, temp.str) == 0)){
                    ketemu = 1;
                }
...
simpul* findSimpul(nilai temp, simpul *root){
    ...
    if(root != NULL){
        // jika ada banyak struck maka bandingkan semuanya
        if(strcmp(root->kontainer.str, temp.str)){
            hasil = root;
        }else{
            ...
            if(bantu != NULL){
                if(bantu->sibling == NULL){
                    // jika ada banyak struck maka bandingkan semuanya
                    if(strcmp(bantu->kontainer.str, temp.str)){
                        hasil = bantu;
                    }else{
